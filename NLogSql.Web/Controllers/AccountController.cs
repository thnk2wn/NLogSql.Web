...
namespace NLogSql.Web.Controllers
{
    ...
    public partial class AccountController : Controller
    {
        ...
        public virtual ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                _log.Debug("Authenticating user {0}", model.UserName);
                if (WebSecurity.Login(model.UserName, model.Password, persistCookie: model.RememberMe))
                {
                    _log.Debug("Authenticated user {0}", model.UserName);
            ...
            _log.Info("Authentication failed for user {0}; invalid username or password", model.UserName);
