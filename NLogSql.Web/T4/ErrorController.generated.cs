...
namespace NLogSql.Web.Controllers
{
    public partial class ErrorController
    {
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string Gone = "Gone";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ErrorController : NLogSql.Web.Controllers.ErrorController
    {
        ...
        partial void GoneOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        public override System.Web.Mvc.ActionResult Gone()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Gone);
            GoneOverride(callInfo);
            return callInfo;
        }
