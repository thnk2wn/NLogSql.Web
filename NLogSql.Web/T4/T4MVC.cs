...
{
    public static NLogSql.Web.Controllers.AccountController Account = new NLogSql.Web.Controllers.T4MVC_AccountController();
    public static NLogSql.Web.Controllers.ErrorController Error = new NLogSql.Web.Controllers.T4MVC_ErrorController();
    public static NLogSql.Web.Controllers.HomeController Home = new NLogSql.Web.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static class images {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string _404_jpg = Url("404.jpg");
            public static readonly string _410_jpg = Url("410.jpg");
            public static readonly string _500_jpg = Url("500.jpg");
